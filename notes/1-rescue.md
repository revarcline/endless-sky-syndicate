...
- 2a. Bring to the Syndicate: Downey on Shangri-La
  - [todo] log for BDowney if not met in Bootstraps (test)
...
Syndicate espionage further side jobs: ScS Spy/Fly \_\_
...
- [bug] Abduction 2b doesn't recognize your passenger.
